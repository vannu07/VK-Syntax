...
export default function CursorGlow() {
  ...
  const layer1X = useSpring(mouseX, { stiffness: 150, damping: 15, mass: 0.1 });
  const layer1Y = useSpring(mouseY, { stiffness: 150, damping: 15, mass: 0.1 });
  
  const layer2X = useSpring(mouseX, { stiffness: 100, damping: 20, mass: 0.3 });
  const layer2Y = useSpring(mouseY, { stiffness: 100, damping: 20, mass: 0.3 });
  
  const layer3X = useSpring(mouseX, { stiffness: 50, damping: 25, mass: 0.5 });
  const layer3Y = useSpring(mouseY, { stiffness: 50, damping: 25, mass: 0.5 });
  
  const layer4X = useSpring(mouseX, { stiffness: 30, damping: 30, mass: 0.8 });
  const layer4Y = useSpring(mouseY, { stiffness: 30, damping: 30, mass: 0.8 });
  ...
  return (
    <>
      ...
      >
        <motion.div
          className="w-[1400px] h-[1400px] -translate-x-1/2 -translate-y-1/2"
          animate={{
            y: [0, 80, 0],
          }}
          transition={{
      ...
      >
        <motion.div
          className="w-[1200px] h-[1200px] -translate-x-1/2 -translate-y-1/2"
          animate={{
            x: [0, 60, 0],
          }}
          transition={{
      ...
      >
        <motion.div
          className="w-[400px] h-[400px] -translate-x-1/2 -translate-y-1/2"
          animate={{
            scale: [1, 1.1, 1],
            rotate: [0, 5, -5, 0],
          }}
      ...
      >
        <motion.div
          className="w-[280px] h-[280px] -translate-x-1/2 -translate-y-1/2"
          animate={{
            scale: [1, 1.15, 0.95, 1],
            rotate: [0, -8, 8, 0],
            borderRadius: [
      ...
      >
        <motion.div
          className="w-[100px] h-[100px] -translate-x-1/2 -translate-y-1/2"
          animate={{
            scale: [1, 1.1, 1],
            borderRadius: [
              '50% 50% 50% 50%',
